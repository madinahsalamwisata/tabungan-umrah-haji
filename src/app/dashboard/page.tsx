...
export default async function DashboardPage() {
  try {
    ...
    return (
      <div className="p-6 bg-red-900/20 border border-red-500/40 rounded-3xl max-w-2xl mx-auto my-10 text-white relative z-50">
        <h2 className="text-xl font-bold text-red-400 mb-2">🔥 Server Runtime Error (Caught):</h2>
        <p className="text-sm font-semibold mb-2">{err?.message || "No message"}</p>
        <pre className="text-xs bg-black/60 p-4 rounded-xl overflow-auto max-h-80 font-mono text-red-200 whitespace-pre-wrap break-all">
