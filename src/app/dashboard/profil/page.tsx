...
export default async function ProfilPage() {
  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div>
        <h1 className="text-2xl font-bold text-emerald-950 drop-shadow-md">Profil Saya</h1>
        <p className="mt-1 text-sm text-emerald-700 drop-shadow-sm">
      ...
      <ProfileForm jamaah={serializedJamaah}>
        ...
        <div className="relative rounded-3xl overflow-hidden mt-0 bg-white/60 backdrop-blur-xl border border-white/60 animate-in fade-in zoom-in-95 duration-500 delay-150">
            ...
            {rencanaAktif.length > 0 ? (
              <div className="grid grid-cols-1 gap-4">
                {rencanaAktif.map((rencana: any) => {
                  ...
                  return (
                    <div key={rencana.id} className="group relative bg-white/40 hover:bg-white/50 border border-white/5 hover:border-white/70 rounded-2xl p-4 transition-all overflow-hidden flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex-1 pl-2 sm:pl-3">
                        <div className="flex items-center gap-2 mb-1.5">
                          <h4 className="text-base font-bold text-emerald-950 group-hover:text-emerald-700 transition-colors line-clamp-1">
                      ...
                      {/* Info Dana */}
                      <div className="sm:text-right shrink-0 bg-white/40 sm:bg-transparent p-3 sm:p-0 rounded-xl sm:rounded-none">
                        <p className="text-[10px] text-gray-600 uppercase tracking-widest font-bold mb-0.5">Terkumpul</p>
              ...
              <div className="text-center py-10 px-4 border border-white/5 rounded-2xl bg-white/40 backdrop-blur-sm">
                ...
                <h3 className="text-base font-bold text-emerald-950 mb-1">Belum Ada Tabungan</h3>
                <p className="text-xs text-gray-600 mb-5 max-w-xs mx-auto">Yuk mulai menabung untuk wujudkan mimpimu ke tanah suci!</p>
                <Link 
                  href="/dashboard/tabungan/baru" 
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-emerald-950 text-sm font-bold rounded-xl shadow-lg hover:shadow-emerald-900/50 transition-all hover:scale-105"
                >
                  Mulai Menabung
