...
export default async function TabunganHajiDashboard() {
  ...
  return (
    <div className="space-y-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
      <div className="relative rounded-[2rem] p-8 md:p-12 shadow-2xl overflow-hidden text-center border border-white/20 bg-white/10 backdrop-blur-xl flex flex-col items-center justify-center">
        ...
        <h2 className="relative z-10 text-lg md:text-xl font-bold text-white mb-3 drop-shadow-sm">Tabungan Haji Segera Hadir</h2>
      ...
      <div className="pt-8 border-t border-white/20">
        <h3 className="text-xl font-bold text-white drop-shadow-md mb-6">Paket Estimasi Haji</h3>
        <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-xl p-12 text-center shadow-sm">
          ...
          <h3 className="mt-2 text-sm font-semibold text-white">Belum ada paket estimasi</h3>
          <p className="mt-1 text-sm text-gray-300">Saat ini belum ada paket estimasi Haji yang tersedia untuk ditampilkan.</p>
        </div>
      </div>
    </div>
  );
