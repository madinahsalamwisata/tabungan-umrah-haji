  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-24">
      ...
      <div className="bg-gradient-to-b from-hijau-900 to-hijau-800 pt-8 pb-6 px-5 sticky top-0 z-20 rounded-b-[2.5rem] shadow-sm">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-white tracking-tight">Pilih Paket</h1>
      ...
      <div className="px-5 mt-6 space-y-5">
        {/* Paket Umrah */}
        <Link href="/dashboard/paket/umrah" className="block relative w-full h-48 rounded-3xl overflow-hidden shadow-md group hover:shadow-lg transition-shadow active:scale-95">
          <Image 
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            <h2 className="text-2xl font-bold text-white tracking-tight drop-shadow-md">Paket Umrah</h2>
          </div>
        </Link>
        ...
        <div onClick={handleComingSoon} className="block relative w-full h-48 rounded-3xl overflow-hidden shadow-md group hover:shadow-lg transition-shadow active:scale-95 cursor-pointer">
          ...
          <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors"></div>
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            <h2 className="text-2xl font-bold text-white tracking-tight drop-shadow-md">Paket Haji</h2>
          </div>
        </div>
      </div>
    </div>
