            ...
            filteredPakets
              ...
              const renderStars = (hotelString: string) => {
                ...
                if (match) {
                  ...
                  return <span className="inline-flex items-center gap-0.5">{stars} <span className="text-white/80 text-[10px] ml-1 font-normal">/Setaraf</span></span>;
                }
                return <span className="text-white/80 text-xs">{hotelString.replace(/\s*\(Atau Setaraf\)/i, "/Setaraf")}</span>;
              };

              return (
                <div 
                  key={paket.id} 
                  className="relative rounded-[2rem] shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300 border border-white/20 bg-black/40 backdrop-blur-xl overflow-hidden group flex flex-col h-full hover:border-white/40"
                >
                  ...
                  <div className="relative z-10 p-5 flex flex-col h-full">
                    ...
                    <div className="flex-1 space-y-3.5 mb-6">
                      ...
                      <div className="flex gap-3 items-center">
                        ...
                        <div>
                          <p className="text-[10px] text-white/70 uppercase tracking-wider font-bold">Bulan Keberangkatan</p>
                      ...
                      <div className="flex gap-3 items-start">
                        ...
                        <div>
                          <p className="text-[10px] text-white/70 uppercase tracking-wider font-bold mb-0.5">Hotel (/Setaraf)</p>
                      ...
                      <div className="flex gap-3 items-center">
                        ...
                        <div>
                          <p className="text-[10px] text-white/70 uppercase tracking-wider font-bold">Maskapai</p>
