...
export default async function TabunganHajiDashboard() {
  ...
  return (
    <div className="space-y-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
      <div className="relative rounded-[2rem] p-8 md:p-12 shadow-2xl overflow-hidden text-center border border-white/20 bg-black/40 backdrop-blur-xl flex flex-col items-center justify-center">
