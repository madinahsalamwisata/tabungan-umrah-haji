...
const targetPath = '/mandiri-virtual-account/v2/payment-code';
const baseUrl = 'https://api-sandbox.doku.com';
const body = { order: { amount: 10000, invoice_number: 'TEST-123' }, virtual_account_info: { expired_time: 60, reusable_status: false, info1: 'test' }, customer: { name: 'test', email: 'test@example.com', phone: '081234567890' } };
