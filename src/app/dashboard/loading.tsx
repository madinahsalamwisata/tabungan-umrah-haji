    ...
    <div className="min-h-screen flex items-center justify-center relative z-50">
      <div className="flex flex-col items-center gap-4 p-8 bg-white/50 rounded-2xl shadow-2xl border border-white/70 backdrop-blur-xl">
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-lg font-semibold text-emerald-700 drop-shadow-md">Memuat Data...</h3>
          <p className="text-sm text-emerald-900/80 animate-pulse mt-1 drop-shadow-sm">Mohon tunggu sebentar</p>
        </div>
      </div>
    </div>
  );
