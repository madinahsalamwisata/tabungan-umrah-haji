...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-emerald-950 drop-shadow-md">Dashboard Admin</h1>
        <p className="text-sm text-gray-600 mt-1">Ringkasan statistik dan aktivitas pendaftaran jamaah.</p>
      </div>

      {/* Stats Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="relative rounded-[1.5rem] shadow-xl overflow-hidden bg-white/60 border border-white/60 p-6">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-emerald-950 mt-2">{totalAkun}</p>
            </div>
        ...
        <div className="relative rounded-[1.5rem] shadow-xl overflow-hidden bg-white/60 border border-white/60 p-6">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-emerald-950 mt-2">{jamaahPasti}</p>
            </div>
            <div className="p-4 bg-emerald-600/20 border border-emerald-500/40 rounded-2xl">
        ...
        <div className="relative rounded-[1.5rem] shadow-xl overflow-hidden bg-white/60 border border-white/60 p-6">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-emerald-950 mt-2">{jamaahEstimasi}</p>
            </div>
        ...
        <div className="relative rounded-[1.5rem] shadow-xl overflow-hidden bg-white/60 border border-white/60 p-6">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="w-[85%] pr-2">
              ...
              <p className="text-lg lg:text-xl font-bold text-emerald-950 mt-2 truncate w-full" title={`Rp ${totalBiaya.toLocaleString('id-ID')}`}>
      ...
      {/* Setoran Terbaru */}
      <div className="relative rounded-[2rem] shadow-xl overflow-hidden bg-white/60 border border-white/60">
        ...
        <div className="relative z-10 px-6 py-6 border-b border-white/60 flex justify-between items-center">
          <div>
            <h3 className="text-lg font-bold text-emerald-950">Aktivitas Setoran Terbaru</h3>
            <p className="text-sm text-gray-600 mt-1">Daftar setoran tabungan terakhir dari jamaah.</p>
          </div>
        </div>

        <div className="relative z-10 overflow-x-auto">
          <table className="w-full text-left text-sm text-gray-700">
            <thead className="text-xs uppercase bg-white/40 text-gray-600 border-b border-white/60">
              <tr>
            ...
            <tbody className="divide-y divide-white/5">
              {setoranTerbaru.map((setoran) => (
                <tr key={setoran.id} className="hover:bg-white/40 transition-colors">
