...
export default async function PaketPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-emerald-950 drop-shadow-md">Pilihan Paket Umrah (Jadwal Pasti)</h2>
        <p className="mt-1 text-sm text-emerald-900/80 drop-shadow-sm">
