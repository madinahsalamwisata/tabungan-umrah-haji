      ...
      <div className="bg-gradient-to-b from-hijau-900 to-hijau-800 pt-6 pb-5 px-5 sticky top-0 z-20 rounded-b-3xl shadow-sm md:relative md:top-auto md:z-0 md:bg-white md:from-transparent md:to-transparent md:border md:border-garis md:rounded-[22px] md:shadow-[0_14px_34px_-18px_rgba(11,61,48,0.15)] md:p-6 md:px-8">
        <div className="flex items-center gap-3">
          <div className="flex-1">
            <h1 className="text-base md:text-2xl font-bold text-white md:text-teks-900 font-display tracking-tight leading-tight">Pilih Tabungan</h1>
            <p className="text-emerald-50/80 md:text-teks-500 text-[11px] md:text-sm font-medium mt-0.5 md:mt-1">Mulai perencanaan ibadah suci Anda dengan mudah</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 mt-6 space-y-5 md:grid md:grid-cols-2 md:gap-6 md:space-y-0 md:px-0 md:mt-8">
        ...
        {isNavigatingUmrah ? (
          ...
          >
            ...
            <div className="absolute inset-0 px-5 flex items-center justify-between">
              <div>
                <h2 className="text-lg md:text-2xl font-serif font-bold text-white tracking-tight drop-shadow-sm">Tabungan Umrah</h2>
        ...
        <div>
          ...
          >
            ...
            <div className="absolute inset-0 px-5 flex items-center justify-between">
              <div>
                <h2 className="text-lg md:text-2xl font-serif font-bold text-white tracking-tight drop-shadow-sm">Tabungan Haji</h2>
