...
export default function ProfileForm({ jamaah }: { jamaah: Jamaah }) {
  ...
  return (
    <div className="relative rounded-[2rem] shadow-2xl overflow-hidden bg-[#111814]">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-[#111814]"></div>
        ...
        <div className="flex justify-between items-end -mt-14 mb-7 relative">
          <div className="relative group">
            ...
            <button 
              ...
              className="absolute bottom-0 right-0 p-1.5 bg-emerald-600 text-white rounded-full border-2 border-[#111814] shadow-sm hover:bg-emerald-700 transition-colors disabled:opacity-50"
              title="Ganti Foto"
            >
              <CameraIcon />
            </button>
