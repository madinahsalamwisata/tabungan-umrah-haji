  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-24">
      ...
      <div className="bg-gradient-to-b from-hijau-900 to-hijau-800 pt-8 pb-6 px-5 sticky top-0 z-20 rounded-b-[2.5rem] shadow-sm">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold text-white tracking-tight">Pilih Tabungan</h1>
      ...
      <div className="px-5 mt-6 space-y-4">
        {/* Tabungan Umrah */}
        <Link href="/dashboard/tabungan/umrah" className="block relative w-full h-32 rounded-[1.5rem] overflow-hidden shadow-sm group hover:shadow-md transition-all active:scale-[0.98]">
          <Image 
          ...
          <div className="absolute inset-0 p-5 flex items-end justify-between">
            <div>
              <h2 className="text-xl font-bold text-white tracking-tight drop-shadow-md">Tabungan Umrah</h2>
              <p className="text-xs text-white/80 mt-0.5 font-medium">Lihat rencana & mulai menabung</p>
            </div>
        ...
        <div>
          ...
          >
            ...
            <div className="absolute inset-0 p-5 flex items-end justify-between">
              <div>
                <h2 className="text-xl font-bold text-white tracking-tight drop-shadow-md">Tabungan Haji</h2>
                <p className="text-xs text-white/80 mt-0.5 font-medium">Persiapkan tabungan haji</p>
              </div>
