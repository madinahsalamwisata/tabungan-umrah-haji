  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-24">
      ...
      <div className="px-5 mt-6 space-y-4">
        {/* Tabungan Umrah */}
        <Link href="/dashboard/tabungan/umrah" className="block relative w-full h-24 rounded-2xl overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,78,59,0.15)] group active:scale-[0.98] transition-transform">
          <Image 
