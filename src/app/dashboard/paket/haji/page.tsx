  ...
  return (
    <div className="space-y-6 mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
      <div className="relative rounded-[2rem] p-8 md:p-12 shadow-2xl overflow-hidden text-center border border-white/20 bg-black/80 backdrop-blur-xl flex flex-col items-center justify-center">
        ...
        <h2 className="relative z-10 text-lg md:text-xl font-bold text-emerald-900 mb-3 drop-shadow-md">Katalog Paket Haji</h2>
      ...
      <div className="pt-4">
        ...
        <div className="bg-black/80 backdrop-blur-xl p-6 rounded-[2rem] shadow-2xl border border-white/20 mb-8">
        ...
        <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-xl p-12 text-center shadow-sm mt-8">
          ...
          <h3 className="mt-2 text-sm font-semibold text-emerald-900">Belum ada data paket</h3>
          <p className="mt-1 text-sm text-emerald-800">Saat ini belum ada data Paket Haji yang tersedia.</p>
        </div>
      </div>
    </div>
  );
